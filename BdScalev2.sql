...
id_empresas_perfil INT AUTO_INCREMENT  , 
nome_empresas VARCHAR(100) NULL , 
nome_membros VARCHAR(200) NULL, 
setor VARCHAR(100) NULL, 
segmento VARCHAR (100) NULL,
mercado_atuacao VARCHAR(200) NULL,
faturamento_ult_ano BIGINT NULL, 
n_colaboradores INT NULL, 
estado VARCHAR(40) NULL,
PRIMARY KEY (id_empresas_perfil)
); 


drop table empresas_perfil;
